...
### Added
- **Deep Link Support**: Added Deep Link adapters for EVM and Tron wallets
  - Support for MetaMask, OKX, TokenPocket, imToken, and TronLink via deep links
  - Enable seamless mobile wallet integration
- **WalletConnect**: Enhanced WalletConnect support for EVM and Tron
